...
void NvEncoder::CreateEncoder(const NV_ENC_INITIALIZE_PARAMS* pEncoderParams)
{
    ...
    // m_nWidth = pEncoderParams->encodeWidth;
    // m_nHeight = pEncoderParams->encodeHeight;
    // m_nMaxEncodeWidth = pEncoderParams->maxEncodeWidth;
    // m_nMaxEncodeHeight = pEncoderParams->maxEncodeHeight;
