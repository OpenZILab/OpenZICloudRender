...
#define MLCES_CV_BIG_UINT(n) n##ULL
    ...
    public:
        ...
        int Write(FShareMemoryData* Data, uint32 Size, uint32 Width, uint32 Height, HANDLE SharedHandle);
        int WriteInternal(FShareMemoryData* Data, uint32 Size, uint32 Width, uint32 Height, HANDLE SharedHandle);
    };
} // namespace OpenZI::CloudRender
...
#define MLCES_CV_BIG_UINT(n) n##ULL
    ...
    public:
        ...
        int WriteInternal(FShareMemoryData* Data, uint32 Size, uint32 Width, uint32 Height, int SharedHandle);
