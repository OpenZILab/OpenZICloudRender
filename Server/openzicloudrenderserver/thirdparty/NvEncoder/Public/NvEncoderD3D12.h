...
public:
    ...
    */
     ...
     */
    void EncodeFrame(std::vector<uint8_t>& vPacket, NV_ENC_PIC_PARAMS* pPicParams = nullptr) override;
    ...
    */
    void EndEncode(std::vector<uint8_t> &vPacket) override;
...
private:
    ...
    */
    void GetEncodedPacket(std::vector<NV_ENC_OUTPUT_RESOURCE_D3D12*>& vOutputBuffer, std::vector<uint8_t>& vPacket, bool bOutputDelay);
